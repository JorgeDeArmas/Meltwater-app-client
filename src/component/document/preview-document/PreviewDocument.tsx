                    ...
                    <div className={`modal-content ${classes['modal-content']}`}>
                        ...
                        <div className="row">
                            <div className="btn-group" role="group">
                                ...
                                />
                                <label className={`btn btn-outline-success ${classes['border-radius-0']}`}
                                       htmlFor="originalDoc"
                                >
                                    Original Document
                                </label>

                                <input id="classifiedDoc"
                                       name="documentPreview"
                                       type="radio"
                                       className="btn-check"
                                       autoComplete="off"
                        ...
                        <div className="modal-body p-0">
                            {state.documentUrl ?
                                <iframe src={`${state.documentUrl}#view=fitH`} title={props.document?.name}
                                        height="100%"
                                        width="100%"
                                /> :
