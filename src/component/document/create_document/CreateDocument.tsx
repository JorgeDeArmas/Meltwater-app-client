                        ...
                        <div className="modal-body">
                            <div className="row">
                                <div className="col-6">
                                    <input name="file"
                                           type="file"
                                           className={`form-control form-control-sm ${createState.form.submitted && !createState.form.fileValid ? classes['form-control-error'] : ''}`}
                                           ref={fileInputRef}
                            ...
                            <div className="row mt-2">
                                <div className="col-12">
                                    {createState.progressBar.visible && <div className="progress">
                            ...
                            <div className="row">
                                <div className="col-12">
                                    ...
                                    <input name="phrase"
                                           type="text"
                                           className={`form-control form-control-sm ${createState.form.submitted && !createState.form.phraseValid ? classes['form-control-error'] : ''}`}
